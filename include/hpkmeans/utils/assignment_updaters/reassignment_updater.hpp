...
public:
    ...
    inline void update(const Matrix<T>* const data, const Matrix<T>* const centroids,
                       VectorView<int32_t>* const assignments, VectorView<T>* const sqDistances) const override
    {
...
private:
    ...
    inline std::enable_if_t<isSingleThreaded(_Level)> updateImpl(const Matrix<T>* const data,
    ...
    template <Parallelism _Level = Level>
    inline std::enable_if_t<isMultiThreaded(_Level)> updateImpl(const Matrix<T>* const data,
                                                                const Matrix<T>* const centroids,
                                                                VectorView<int32_t>* const assignments,
                                                                VectorView<T>* const sqDistances) const
    {
#pragma omp parallel for schedule(static)
    ...
    inline void updateIteration(const int32_t dataIdx, const Matrix<T>* const data, const Matrix<T>* const centroids,
