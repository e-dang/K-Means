...
public:
    ...
    AbstractCoresetCreator* createCoresetCreator(CoresetCreator coresetCreator, const int& sampleSize,
...
protected:
    ...
    virtual AbstractCoresetCreator* getLWCoreset(const int& sampleSize,
...
public:
    ...
    AbstractCoresetCreator* getLWCoreset(const int& sampleSize, std::shared_ptr<IDistanceFunctor> distanceFunc)
    {
