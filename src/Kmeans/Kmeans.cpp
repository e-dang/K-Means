...
std::shared_ptr<ClusterResults> AbstractKmeans::run(const Matrix* const data, const int32_t& numClusters,
                                                    const int& numRestarts, KmeansData* const kmeansData)
{
    ...
    for (int32_t i = 0; i < numRestarts; i++)
    {
...
std::shared_ptr<ClusterResults> WeightedKmeans::fit(const Matrix* const data, const int32_t& numClusters,
...
std::shared_ptr<ClusterResults> CoresetKmeans::fit(const Matrix* const data, const int32_t& numClusters,
                                                   const int& numRestarts)
{
